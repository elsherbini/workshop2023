...
### Schedule (! To be updated with lecture slide points)
**Wednesday (4/24)**
...
|                |- Begin sample inference with Dada2                                                |
+----------------+-----------------------------------------------------------------------------------+
|10:30 - 11:00am | **Break**                                                                         |
+----------------+-----------------------------------------------------------------------------------+
|11:00- 12:00pm  |- Merge in metadata, qPCR, and Luminex data                                        |
...
| Time           | Task                                                                                |
+================+=====================================================================================+
| 1:30 - 2:00pm  |- Phyloseq processing and visualizations                                             |
+----------------+-------------------------------------------------------------------------------------+
| 2:00 - 3:00pm  |- Differential abundance testing                                                     |
|                |- Running shotgun metagenomics and integrating into phyloseq                         |
+----------------+-------------------------------------------------------------------------------------+
|3:00 - 3:30pm   | **Break**                                                                           |
+----------------+-------------------------------------------------------------------------------------+
|3:30 - 5:00pm   |- etc                                                                                |
...
### Example workflows
[Johnathan's Demo (temporary test)](johnathan_yogurt_demo.rmd)
